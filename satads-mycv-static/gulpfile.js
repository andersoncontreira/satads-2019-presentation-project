...
function modules() {
  ...
  return merge(bootstrap, fontAwesome, jquery, jqueryEasing, vue, sweetalert2);
}
...
const dist = gulp.series(cleanDist, build, buildDist);
const run = gulp.series(browserSync);
